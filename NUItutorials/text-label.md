...
|  |  |
|--|--|
| (ParentOrigin.TOP_LEFT) | ![ ](./Images/TextLabelTopLeft.png)   |
...
An example of arabic can be seen The images in the [Text Alignment] section
...
There are priorities when styles are applied while renedering text.
...
Examples below are equivalent, render the text in red. Second example codes the color in 0xAARRGGBB.
